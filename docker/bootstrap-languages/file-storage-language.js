// Docker file-storage language — stores file expressions locally.
//
// Replaces the centralized Cloudflare Workers KV file store for
// Docker deployments. Uses ad4m:host storagePut/storageGet for
// persistence within the executor's per-language storage directory.
import {
...
export const name = "docker-file-store";
