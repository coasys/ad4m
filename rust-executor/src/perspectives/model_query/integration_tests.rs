...
fn pv_signed(
    signer: &crate::agent::signatures::TestSigner,
    source: &str,
    predicate: &str,
    target: &str,
    second: u32,
...
fn pv_seed(store: &SparqlStore) -> crate::agent::signatures::TestSigner {
    let signer = crate::agent::signatures::TestSigner::generate();
    let r = "pv://r/1";
    store
