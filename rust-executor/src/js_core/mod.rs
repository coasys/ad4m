use deno_core::v8::{self, Global, Value};
use ::futures::Future;
...
impl JsCore {
    ...
    fn execute_async_smart<'a>(
        &'a self,
        script: String
    ) -> impl Future<Output = Result<String, AnyError>> + 'a {
        ...
        async move {
            ...
            let poll_value = worker.js_runtime.resolve(execute_async);
