...
use rust_executor::js_core::ad4m_language_extensions;
...
fn main() {
    ...
    // One list, shared with the language runtime (see ad4m_language_extensions).
    let extensions = ad4m_language_extensions();
