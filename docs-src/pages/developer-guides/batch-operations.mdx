...
- Reduces the number of internal engine updates (SurrealDB indexing, query subscriptions)
...
- Internal indexes (SurrealDB, query subscriptions) are updated only once per batch commit
