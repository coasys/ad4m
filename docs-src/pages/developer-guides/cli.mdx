...
# --port: API port (default: 12000)
# --admin-credential: Bypass authentication handshake
# --app-data-path: Custom data directory (default: ~/.ad4m)
# --run-dapp-server: Run the DApp server (default: false)
...
ad4m-executor run \
  ...
  --hc-use-proxy true \
  --hc-proxy-url url \
  --hc-bootstrap-url url
# --hc-admin-port: Holochain admin interface port (default: 1234)
# --hc-app-port: Holochain app interface port (default: 8888)
# --hc-use-bootstrap: Use bootstrap service (default: true)
# --hc-use-proxy: Use proxy for Holochain (default: true)
# --hc-proxy-url: Custom proxy URL
# --hc-bootstrap-url: Custom bootstrap URL
```
...
ad4m-executor run \
  ...
  --hc-app-port 9888 \
  --app-data-path ~/.ad4m2
# --port: Different API port
# --hc-admin-port: Different Holochain admin port
# --hc-app-port: Different Holochain app port
# --app-data-path: Separate data directory
```

When connecting to the second executor with the client, specify the custom port:
