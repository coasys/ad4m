...
- Initialize: Launch it to generate or unlock an agent (DID and keys). It runs on localhost:12000, offering a WebSocket RPC endpoint.
...
const client = new Ad4mClient("http://localhost:12000");
