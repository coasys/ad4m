...
ADAM and Social DNA provide a flexible and semantically rich environment for representing and reasoning about data. To make this environment even more accessible and useful to app developers, we have introduced the concept of "Subject Classes".
