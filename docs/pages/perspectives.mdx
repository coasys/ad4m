...
A Perspective is essentially a local graph databases that
contains the associations between [Expressions](/essentials/expressions).
...
Creating a Perspective can be done easily like this:
