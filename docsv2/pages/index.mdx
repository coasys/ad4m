...
<Callout type="info">
  The name AD4M is an ackronym for _The **A**gent-Centric **D**istributed
  **A**pplication **M**eta-ontology_ or just: **A**gent-Centric **DA**pp
  **M**eta-ontology.
</Callout>
...
It tries to capture the quintessence of what _really_ goes on in human communication networks,
...
What _really goes on_ is that agents/humans exchange expressions of various (and evolving) languages
...
![AD4M ontology](/images/ad4m-ontology.png)
