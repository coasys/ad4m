...
import {
    AGENT_MUTATION_CAPABILITY, AGENT_QUERY_CAPABILITY, ALL_CAPABILITY, AUTH_CAPABILITY, checkCapability,
    ...
    RUNTIME_KNOWN_LINK_LANGUAGES_QUERY_CAPABILITY, RUNTIME_TRUSTED_AGENTS_QUERY_CAPABILITY,
} from '../agent/Auth'
