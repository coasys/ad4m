...
export type NotificationTriggeredCallback = (
  notification: TriggeredNotification,
) => null;
export type NotificationRequestedCallback = (
...
export class RuntimeClient {
  ...
  async removeKnownLinkLanguageTemplates(
    addresses: string[],
  ): Promise<string[]> {
