...
// Only request/response types are exported.
...
export type { ExtractionLink } from "./ExtractionLink";
export type { ExtractionPlacement } from "./ExtractionPlacement";
...
export type { RunExtractionRequest } from "./RunExtractionRequest";
