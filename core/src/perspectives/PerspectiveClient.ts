...
export type PerspectiveHandleCallback = (
...
export class PerspectiveClient {
  ...
  async disposeQuerySubscription(
    uuid: string,
    subscriptionId: string,
  ): Promise<boolean> {
      ...
      await this.#apolloClient.mutate({
        mutation: gql`
          mutation perspectiveDisposeQuerySubscription(
            ...
            perspectiveDisposeQuerySubscription(
              uuid: $uuid
              subscriptionId: $subscriptionId
            )
          }
        ...
        mutation: gql`
          mutation perspectiveCreateSubject(
            ...
            perspectiveCreateSubject(
              ...
              expressionAddress: $expressionAddress
  ...
  async addPerspectiveLinkAddedListener(
    uuid: String,
    cb: LinkCallback[],
  ): Promise<void> {
    this.#apolloClient
  ...
  async addPerspectiveLinkRemovedListener(
    uuid: String,
    cb: LinkCallback[],
  ): Promise<void> {
    this.#apolloClient
  ...
  async addPerspectiveLinkUpdatedListener(
    uuid: String,
    cb: LinkCallback[],
  ): Promise<void> {
    this.#apolloClient
