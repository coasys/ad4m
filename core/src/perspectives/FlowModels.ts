 ...
 * `flow_instance/atom.rs`. This class is the client-side mirror of that shape:
...
// Mirrors the Rust hardwired `flow_transition_proposal.json` SDNA. One node per
// proposed transition; the
