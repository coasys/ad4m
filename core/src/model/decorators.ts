...
export interface PropertyOptions {
     ...
     * an `ad4m://extraction_hint` link on the property shape and surfaced
     * on `ShapeProperty.extraction_hint` by the Rust model query so the
...
export interface ModelConfig {
     ...
     * `ad4m://extraction_hint` link on the SHACL shape node and surfaced
