...
describe("SHACLShape", () => {
  describe("toLinks()", () => {
    ...
    it("creates action links", () => {
      ...
      const setterLink = links.find(
        (l) =>
          l.source === "recipe://Recipe.title" &&
          l.predicate === "ad4m://setter",
      );
  ...
  describe("fromLinks()", () => {
    ...
    it("handles multiple properties", () => {
      ...
      const nameProp = reconstructed.properties.find(
        (p) => p.path === "recipe://name",
      );
      const servingsProp = reconstructed.properties.find(
        (p) => p.path === "recipe://servings",
      );
  ...
  describe("round-trip serialization", () => {
    it("preserves all property attributes", () => {
      ...
      expect(prop.readOnly).toBeFalsy();
  ...
  describe("edge cases", () => {
    ...
    it("handles URI with hash fragment", () => {
      ...
      expect(targetClassLink!.source).toBe(
        "https://example.com/vocab#RecipeShape",
      );
    });
  ...
  describe("toJSON/fromJSON", () => {
    ...
    it("preserves constructor and destructor actions", () => {
      ...
      expect(reconstructed.constructor_actions).toEqual(
        original.constructor_actions,
      );
      expect(reconstructed.destructor_actions).toEqual(
        original.destructor_actions,
      );
    });
