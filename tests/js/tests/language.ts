    ...
    return () => {
        describe('with a perspective-diff-sync templated by Alice', () => {
            ...
            it('can publish and template a non-Holochain language and provide correct meta data', async() => {
                ...
                expect(canPublishNonHolochainLang.address).to.be.equal("QmzSYwdfrDHN2DuuEmsDqhkJnQjSbMy6s34VZchxAu17uqejsaK");
                ...
                expect(sourceLanguageMetaNonHCData.address).to.be.equal("QmzSYwdfrDHN2DuuEmsDqhkJnQjSbMy6s34VZchxAu17uqejsaK")
            })
