#!/usr/bin/env bash
# Build the agent-language Rust ALDK crate into a single-file WASM ES module
# and copy the resulting bundle.js into ../build/ so the bootstrap loader
# picks it up like any other language bundle.
set -euo pipefail
...
WASM_IN="target/wasm32-unknown-unknown/release/agent_language.wasm"
...
echo "==> agent-language (Rust ALDK) built:"
