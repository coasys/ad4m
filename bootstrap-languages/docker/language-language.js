// Docker language-language — stores language meta + bundles locally.
//
// Uses ad4m:host storageGet/storagePut for persistence within the
// executor's per-language storage directory. For Docker deployments,
// bundles are pre-populated on disk during container init, so the
// language-language never needs network access.
import {
...
export const name = "docker-language-store";
