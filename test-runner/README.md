...
This is a testing library for testing languages for ad4m. This package internally uses [ad4m-host](https://github.com/coasys/ad4m/tree/dev/host) to start and interact with ad4m-executor. For more detailed example look [here](https://github.com/coasys/ad4m/tree/dev/test-runner/example)
